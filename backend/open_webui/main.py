...
from open_webui.config import (  # Ollama; OpenAI; Direct Connections; Thread pool size for FastAPI/AnyIO; Tool Server Configs; Code Execution; Image; Audio; Retrieval; WebUI; WebUI (OAuth); WebUI (LDAP); Misc
    ADMIN_EMAIL,
...
app.state.AUTH_TRUSTED_OUTSETA_ID_HEADER = WEBUI_AUTH_TRUSTED_OUTSETA_ID_HEADER
...
app.include_router(
    domain_lookups.router, prefix="/api/v1/domain_lookups", tags=["domain_lookups"]
)
